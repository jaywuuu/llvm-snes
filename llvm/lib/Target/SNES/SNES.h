...
#ifndef LLVM_LIB_TARGET_SNES_SNES_H
#define LLVM_LIB_TARGET_SNES_SNES_H
...
void LowerSNESMachineInstrToMCInst(const MachineInstr *MI, MCInst &OutMI,
                                   AsmPrinter &AP);
} // namespace llvm

namespace llvm {
// Enums corresponding to SNES condition codes, both icc's and fcc's.  These
...
inline static const char *SNESCondCodeToString(SPCC::CondCodes CC) {
  switch (CC) {
  case SPCC::ICC_A:
    return "a";
  case SPCC::ICC_N:
