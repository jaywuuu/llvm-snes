...
static const unsigned PRRegDecoderTable[] = {
    SP::TPC,      SP::TNPC,     SP::TSTATE,  SP::TT,
    SP::TICK,     SP::TBA,      SP::PSTATE,  SP::TL,
    SP::PIL,      SP::CWP,      SP::CANSAVE, SP::CANRESTORE,
    SP::CLEANWIN, SP::OTHERWIN, SP::WSTATE,  SP::PC};
...
#include "SNESGenDisassemblerTables.inc"
...
DecodeStatus SNESDisassembler::getInstruction(MCInst &Instr, uint64_t &Size,
  ...
  if (STI.getFeatureBits()[SNES::FeatureV9]) {
    Result = decodeInstruction(DecoderTableSNESV932, Instr, Insn, Address, this,
                               STI);
  } else {
    Result = decodeInstruction(DecoderTableSNESV832, Instr, Insn, Address, this,
                               STI);
  }
  if (Result != MCDisassembler::Fail)
    return Result;
  ...
  Result =
      decodeInstruction(DecoderTableSNES32, Instr, Insn, Address, this, STI);
