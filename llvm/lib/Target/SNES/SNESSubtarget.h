...
#ifndef LLVM_LIB_TARGET_SNES_SNESSUBTARGET_H
#define LLVM_LIB_TARGET_SNES_SNESSUBTARGET_H
...
public:
  ...
  SNESSubtarget &initializeSubtargetDependencies(StringRef CPU, StringRef FS);
