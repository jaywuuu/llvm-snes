//===-- SNESMCInstLower.cpp - Convert SNES MachineInstr to MCInst -------===//
...
static MCOperand LowerSymbolOperand(const MachineInstr *MI,
  ...
  SNESMCExpr::VariantKind Kind = (SNESMCExpr::VariantKind)MO.getTargetFlags();
  ...
  const SNESMCExpr *expr = SNESMCExpr::create(Kind, MCSym, AP.OutContext);
...
void llvm::LowerSNESMachineInstrToMCInst(const MachineInstr *MI, MCInst &OutMI,
                                         AsmPrinter &AP) {
