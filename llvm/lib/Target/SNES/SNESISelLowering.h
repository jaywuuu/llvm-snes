...
#ifndef LLVM_LIB_TARGET_SNES_SNESISELLOWERING_H
#define LLVM_LIB_TARGET_SNES_SNESISELLOWERING_H
...
public:
  SNESTargetLowering(const TargetMachine &TM, const SNESSubtarget &STI);
